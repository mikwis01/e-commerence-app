...
export const Searchbar = () => {
  return (
    <div
      className={`flex items-center justify-between w-full md:w-4/6 h-8 text-white rounded border-[1px] border-grayLight`}>
      <input
        type="text"
        placeholder="Search ..."
      ...
      <select className="appearance-none bg-graySemiDark flex items-center pb-0.5 text-center w-1/3 h-full">
